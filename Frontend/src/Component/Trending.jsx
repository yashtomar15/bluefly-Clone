    ...
    <>
      ...
      <div className="trending">
        <div>
          ...
          <div className="card">
            <img
              src="https://saint-laurent.dam.kering.com/m/1624103afbc1b5b/Medium-620090DWE007660_A.jpg"
              alt="img"
            />
            <p>SAINT LAURENT TRIBUTE LEATHER SANDAL</p>
            <span className="strikethrough">$595</span>
            <span>From $526</span>
            <span>Save25%</span>
          </div>
          ...
          <div className="card">
            <img
              src="https://cdn-images.farfetch-contents.com/16/77/96/86/16779686_35284986_600.jpg"
              alt="img"
            />
            <p>BOTTEGA VENETA FLASH LEATHER BOOTIE</p>
            <span className="strikethrough">$1350</span>
            <span>From $1189</span>
            <span>Save15%</span>
          </div>
          ...
          <div className="card">
            <img
              src="https://images.selfridges.com/is/image/selfridges/926-10004-2387524039_NUDE_M?$PDP_M_ZOOM$"
              alt="img"
            />
          ...
          <div className="card">
            <img
              src="https://cdn.shopify.com/s/files/1/0248/3473/6191/products/1311886728_RLLZ_2_620x.jpg?v=1641624969"
              alt="img"
            />
            <p>STUART WEITZMAN HENLEY LEATHER BOOTIE</p>
            <span className="strikethrough">$695</span>
            <span>From $354</span>
            <span>Save50%</span>
          </div>
          ...
          <div className="card">
            <img
              src="https://cache.net-a-porter.com/images/products/1119320/1119320_fr_2000_q80.jpg"
              alt="img"
            />
            <p>BALENCIAGA TRIPLE S SNEAKER</p>
            <span className="strikethrough">$900</span>
            <span>From $439</span>
            <span>Save65%</span>
          </div>
        ...
        <p className="trendingBtnDiv">
          {/* See All */}
          <button className="trendingBtn"> See All</button>
        </p>
        <hr />
      </div>
    </>
