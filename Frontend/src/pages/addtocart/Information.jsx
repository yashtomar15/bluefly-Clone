...
export const Information = () => {
  ...
  console.log(state,"from information");
  if (!state.cart.token) {
    // alert(state.cart.token,"token");
    navigate("/login");
              ...
              <Typography variant="h6" color="inherit" noWrap width="100%">
                ...
                >
                  <div
                    ...
                    onClick={() => {
                      alert("serverDown please try after sometime or choose COD");
                    }}
                  >
                    <img
