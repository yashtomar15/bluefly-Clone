      ...
      >
        ...
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap width="100%">
            ...
            <div style={{height:"50px",width:"30%",background:"#3c0def",borderRadius:"5px",textAlign:"center",cursor:"pointer"}} onClick={()=>{
                alert("serverDown please try later")
            }}><img src="https://image.shutterstock.com/image-photo/paytm-editorial-illustrative-photo-news-600w-2154668717.jpg" height="40" width="50"/></div>
            <div style={{height:"50px",width:"30%",background:"#FFC439",borderRadius:"5px",textAlign:"center",cursor:"pointer"}} onClick={()=>{
                alert("serverDown please try later")
            ...
            <div style={{height:"50px",width:"30%",background:"black",borderRadius:"5px",textAlign:"center" ,cursor:"pointer"}}onClick={()=>{
                alert("serverDown please try later")
            }}><img src="https://image.shutterstock.com/image-photo/smart-phone-google-pay-logo-600w-1572992740.jpg" height="40" width="50"/></div>
            </div>
          </Typography>
        </Toolbar>
      </AppBar>
