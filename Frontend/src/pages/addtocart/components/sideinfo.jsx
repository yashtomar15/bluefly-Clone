...
export const Sideinfo = () => {
  ...
  return (
    <Sideinfodiv>
            ...
            state.updateddata.map((ele)=>{
                return(
                    <Sideinfodivcont>
                        ...
                        {<img src={ele.images1.main} height="70" width="80" style={{borderRadius:"20px"}}></img>}
                        </Badge>
                        </div>
                        <div>
                            <p>{ele.title}</p>
        ...
        <div>
            <input placeholder='Gift Card or discount code' style={{height:"50px",marginTop:"5%",marginLeft:"25%",width:"250px"}} onChange={(e)=>
                setinput(e.target.value)}/>
            <button style={{height:"50px",width:"50px",border:"none",background:"grey",color:"white"}} onClick={applycopoun}>Apply</button>
        </div>
        ...
        <Forbuttons2>
            <p>Total</p>
            <p>${state.total+Number(19.95)+Number(60.00)}</p>
        </Forbuttons2>
    </Sideinfodiv>
  )
}
