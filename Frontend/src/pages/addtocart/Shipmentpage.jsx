...
export const Shipment=()=>{
    ...
    return(
        ...
        <Maininfopage>
           <div style={{width:"50%"}}>
            <div style={{width:"80%",height:"60px",border:"1px solid grey",marginTop:"5%",marginBottom:"5%",borderRadius:"5px",alignItems:"center"}}>
                <div style={{display:"flex",justifyContent:"space-around",paddingBottom:"1%",alignItems:"center"}}>
                    ...
                    <p tyle={{fontWeight:"bold",cursor:"pointer"}} onClick={()=>navigate("/cart/information")}>Change</p>
                </div>
